...
| Baseline | Use one direct prompt with the same idea and output schema to measure a reasonable basic approach. | Pending: `evaluation/results/baseline/` | Pending | Planned |
